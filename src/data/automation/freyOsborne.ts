...
export const FREY_OSBORNE_2017: Record<string, FreyOsborneEntry> = {
  ...
  "15-1252": { socCode: "15-1252", occupation: "Software Developer", probability: 0.043 },
  "15-1251": { socCode: "15-1251", occupation: "Computer Programmer", probability: 0.48 },
  "15-1254": { socCode: "15-1254", occupation: "Web Developer", probability: 0.21 },
  "15-1242": { socCode: "15-1242", occupation: "Database Administrator", probability: 0.03 },
  "15-1244": { socCode: "15-1244", occupation: "Network and Computer Systems Administrator", probability: 0.03 },
  ...
  "43-3031": { socCode: "43-3031", occupation: "Bookkeeping, Accounting, and Auditing Clerk", probability: 0.98 },
  "43-9061": { socCode: "43-9061", occupation: "Office Clerk, General", probability: 0.96 },
  "43-6014": { socCode: "43-6014", occupation: "Secretary or Administrative Assistant", probability: 0.96 },
  "43-4051": { socCode: "43-4051", occupation: "Customer Service Representative", probability: 0.55 },
  ...
  "27-3091": { socCode: "27-3091", occupation: "Interpreter or Translator", probability: 0.38 },

  // --- Management ---
  "11-2021": { socCode: "11-2021", occupation: "Marketing Manager", probability: 0.014 },
  ...
  "25-2031": { socCode: "25-2031", occupation: "Secondary School Teacher", probability: 0.0078 },
  "25-2021": { socCode: "25-2021", occupation: "Elementary School Teacher", probability: 0.0044 },

  // --- Health ---
  "29-1141": { socCode: "29-1141", occupation: "Registered Nurse", probability: 0.009 },
  ...
  "49-2094": { socCode: "49-2094", occupation: "Electrical and Electronic Equipment Repairer", probability: 0.78 },
  ...
  "49-3023": { socCode: "49-3023", occupation: "Automotive Service Technician or Mechanic", probability: 0.59 },
  "47-2111": { socCode: "47-2111", occupation: "Electrician", probability: 0.15 },
  "47-2152": { socCode: "47-2152", occupation: "Plumber, Pipefitter, Steamfitter", probability: 0.35 },
  "47-2031": { socCode: "47-2031", occupation: "Carpenter", probability: 0.72 },
  ...
  // --- Retail / sales ---
  "41-2031": { socCode: "41-2031", occupation: "Retail Salesperson", probability: 0.92 },
  "41-2011": { socCode: "41-2011", occupation: "Cashier", probability: 0.97 },
  ...
  // --- Agriculture ---
  "11-9013-A": { socCode: "11-9013-A", occupation: "Farmer, Rancher, or Agricultural Manager (smallholder)", probability: 0.47 },
  "45-2092": { socCode: "45-2092", occupation: "Farmworker / Crop Laborer", probability: 0.87 },
  ...
  // --- Tailoring / textile ---
  "51-6052": { socCode: "51-6052", occupation: "Tailor, Dressmaker, Custom Sewer", probability: 0.84 },
