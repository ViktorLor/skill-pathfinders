/**
 * ISO 3166-1 country list (alpha-3 code + name + flag emoji).
 *
 * This list is the authoritative source for the "country of residence"
...
export const ISO_COUNTRIES: IsoCountry[] = [
  ...
  { code: "COD", name: "Congo, Democratic Republic of the", flag: "🇨🇩" },
  ...
  { code: "FLK", name: "Falkland Islands (Malvinas)", flag: "🇫🇰" },
  ...
  { code: "PRK", name: "Korea, Democratic People's Republic of", flag: "🇰🇵" },
  { code: "KOR", name: "Korea, Republic of", flag: "🇰🇷" },
  ...
  { code: "FSM", name: "Micronesia, Federated States of", flag: "🇫🇲" },
  ...
  { code: "PSE", name: "Palestine, State of", flag: "🇵🇸" },
...
export function getIsoCountry(code: string): IsoCountry | null {
  if (!code) return null;
